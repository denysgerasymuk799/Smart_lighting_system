// ======================================================================
// Mesh_Flood_PSoC4BLE_Main_Brightness.v generated from TopDesign.cysch
// 01/16/2021 at 23:23
...
module top ;
	...
	wire [0:0] tmpOE__Pin_Mic_D_net;
	wire [0:0] tmpIO_0__Pin_Mic_D_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Mic_D_net;
	electrical [0:0] tmpSIOVREF__Pin_Mic_D_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Mic_D
		 (.oe(tmpOE__Pin_Mic_D_net),
		  .y({1'b0}),
		  .fb({Net_200}),
		  .io({tmpIO_0__Pin_Mic_D_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Mic_D_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Mic_D_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Mic_D_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_DLed_net;
	wire [0:0] tmpFB_0__Pin_DLed_net;
	wire [0:0] tmpIO_0__Pin_DLed_net;
	wire [0:0] tmpINTERRUPT_0__Pin_DLed_net;
	electrical [0:0] tmpSIOVREF__Pin_DLed_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_DLed
		 (.oe(tmpOE__Pin_DLed_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_DLed_net[0:0]}),
		  .io({tmpIO_0__Pin_DLed_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_DLed_net),
		  .interrupt({tmpINTERRUPT_0__Pin_DLed_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_DLed_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_Mic_A_net;
	wire [0:0] tmpFB_0__Pin_Mic_A_net;
	wire [0:0] tmpIO_0__Pin_Mic_A_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Mic_A_net;
	electrical [0:0] tmpSIOVREF__Pin_Mic_A_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Mic_A
		 (.oe(tmpOE__Pin_Mic_A_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_Mic_A_net[0:0]}),
		  .analog({Net_64}),
		  .io({tmpIO_0__Pin_Mic_A_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Mic_A_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Mic_A_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Mic_A_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    ADC_SAR_SEQ_P4_v2_50_2 ADC_MIC (
        .Vref(Net_552),
        .sdone(Net_553),
        .eoc(Net_554),
        .aclk(1'b0),
    ...
    TCPWM_P4_v2_10_3 PWM_Brightness (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(1'b1),
	...
	wire [0:0] tmpOE__Pin_ALed_net;
	wire [0:0] tmpFB_0__Pin_ALed_net;
	wire [0:0] tmpIO_0__Pin_ALed_net;
	wire [0:0] tmpINTERRUPT_0__Pin_ALed_net;
	electrical [0:0] tmpSIOVREF__Pin_ALed_net;

	cy_psoc3_pins_v1_10
		#(.id("0ef97bf9-3fd6-4b3a-9fcb-e58497261af1"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_ALed
		 (.oe(tmpOE__Pin_ALed_net),
		  .y({Net_249}),
		  .fb({tmpFB_0__Pin_ALed_net[0:0]}),
		  .io({tmpIO_0__Pin_ALed_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_ALed_net),
		  .interrupt({tmpINTERRUPT_0__Pin_ALed_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_ALed_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Pin_Timer_Clear_net;
	wire [0:0] tmpIO_0__Pin_Timer_Clear_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Timer_Clear_net;
	electrical [0:0] tmpSIOVREF__Pin_Timer_Clear_net;

	cy_psoc3_pins_v1_10
		#(.id("4fe150ab-67c7-45bb-a9aa-9aa6f1b92ebe"),
		  .drive_mode(3'b111),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Timer_Clear
		 (.oe(tmpOE__Pin_Timer_Clear_net),
		  .y({1'b0}),
		  .fb({Net_634}),
		  .io({tmpIO_0__Pin_Timer_Clear_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Timer_Clear_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Timer_Clear_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
