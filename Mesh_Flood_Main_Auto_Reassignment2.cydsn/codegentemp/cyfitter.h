...
/* Timer_Is_Free */
#define Timer_Is_Free_Clock__CTRL_REGISTER CYREG_PERI_PCLK_CTL9
...
#define Timer_Is_Free_cy_m0s8_tcpwm_1__CC CYREG_TCPWM_CNT2_CC
#define Timer_Is_Free_cy_m0s8_tcpwm_1__CC_BUFF CYREG_TCPWM_CNT2_CC_BUFF
#define Timer_Is_Free_cy_m0s8_tcpwm_1__COUNTER CYREG_TCPWM_CNT2_COUNTER
#define Timer_Is_Free_cy_m0s8_tcpwm_1__CTRL CYREG_TCPWM_CNT2_CTRL
#define Timer_Is_Free_cy_m0s8_tcpwm_1__INTR CYREG_TCPWM_CNT2_INTR
#define Timer_Is_Free_cy_m0s8_tcpwm_1__INTR_MASK CYREG_TCPWM_CNT2_INTR_MASK
#define Timer_Is_Free_cy_m0s8_tcpwm_1__INTR_MASKED CYREG_TCPWM_CNT2_INTR_MASKED
#define Timer_Is_Free_cy_m0s8_tcpwm_1__INTR_SET CYREG_TCPWM_CNT2_INTR_SET
#define Timer_Is_Free_cy_m0s8_tcpwm_1__PERIOD CYREG_TCPWM_CNT2_PERIOD
#define Timer_Is_Free_cy_m0s8_tcpwm_1__PERIOD_BUFF CYREG_TCPWM_CNT2_PERIOD_BUFF
#define Timer_Is_Free_cy_m0s8_tcpwm_1__STATUS CYREG_TCPWM_CNT2_STATUS
#define Timer_Is_Free_cy_m0s8_tcpwm_1__TCPWM_CMD CYREG_TCPWM_CMD
#define Timer_Is_Free_cy_m0s8_tcpwm_1__TCPWM_CMDCAPTURE_MASK 0x04u
#define Timer_Is_Free_cy_m0s8_tcpwm_1__TCPWM_CMDCAPTURE_SHIFT 2u
#define Timer_Is_Free_cy_m0s8_tcpwm_1__TCPWM_CMDRELOAD_MASK 0x400u
#define Timer_Is_Free_cy_m0s8_tcpwm_1__TCPWM_CMDRELOAD_SHIFT 10u
#define Timer_Is_Free_cy_m0s8_tcpwm_1__TCPWM_CMDSTART_MASK 0x4000000u
#define Timer_Is_Free_cy_m0s8_tcpwm_1__TCPWM_CMDSTART_SHIFT 26u
#define Timer_Is_Free_cy_m0s8_tcpwm_1__TCPWM_CMDSTOP_MASK 0x40000u
#define Timer_Is_Free_cy_m0s8_tcpwm_1__TCPWM_CMDSTOP_SHIFT 18u
#define Timer_Is_Free_cy_m0s8_tcpwm_1__TCPWM_CTRL CYREG_TCPWM_CTRL
#define Timer_Is_Free_cy_m0s8_tcpwm_1__TCPWM_CTRL_MASK 0x04u
#define Timer_Is_Free_cy_m0s8_tcpwm_1__TCPWM_CTRL_SHIFT 2u
#define Timer_Is_Free_cy_m0s8_tcpwm_1__TCPWM_INTR_CAUSE CYREG_TCPWM_INTR_CAUSE
#define Timer_Is_Free_cy_m0s8_tcpwm_1__TCPWM_INTR_CAUSE_MASK 0x04u
#define Timer_Is_Free_cy_m0s8_tcpwm_1__TCPWM_INTR_CAUSE_SHIFT 2u
#define Timer_Is_Free_cy_m0s8_tcpwm_1__TCPWM_NUMBER 2u
#define Timer_Is_Free_cy_m0s8_tcpwm_1__TR_CTRL0 CYREG_TCPWM_CNT2_TR_CTRL0
#define Timer_Is_Free_cy_m0s8_tcpwm_1__TR_CTRL1 CYREG_TCPWM_CNT2_TR_CTRL1
#define Timer_Is_Free_cy_m0s8_tcpwm_1__TR_CTRL2 CYREG_TCPWM_CNT2_TR_CTRL2
#define Timer_Is_Free_isr__INTC_CLR_EN_REG CYREG_CM0_ICER
#define Timer_Is_Free_isr__INTC_CLR_PD_REG CYREG_CM0_ICPR
#define Timer_Is_Free_isr__INTC_MASK 0x80000u
#define Timer_Is_Free_isr__INTC_NUMBER 19u
#define Timer_Is_Free_isr__INTC_PRIOR_MASK 0xC0000000u
#define Timer_Is_Free_isr__INTC_PRIOR_NUM 3u
#define Timer_Is_Free_isr__INTC_PRIOR_REG CYREG_CM0_IPR4
...
/* Timer_Change_Color */
#define Timer_Change_Color_cy_m0s8_tcpwm_1__CC CYREG_TCPWM_CNT0_CC
#define Timer_Change_Color_cy_m0s8_tcpwm_1__CC_BUFF CYREG_TCPWM_CNT0_CC_BUFF
#define Timer_Change_Color_cy_m0s8_tcpwm_1__COUNTER CYREG_TCPWM_CNT0_COUNTER
#define Timer_Change_Color_cy_m0s8_tcpwm_1__CTRL CYREG_TCPWM_CNT0_CTRL
#define Timer_Change_Color_cy_m0s8_tcpwm_1__INTR CYREG_TCPWM_CNT0_INTR
#define Timer_Change_Color_cy_m0s8_tcpwm_1__INTR_MASK CYREG_TCPWM_CNT0_INTR_MASK
#define Timer_Change_Color_cy_m0s8_tcpwm_1__INTR_MASKED CYREG_TCPWM_CNT0_INTR_MASKED
#define Timer_Change_Color_cy_m0s8_tcpwm_1__INTR_SET CYREG_TCPWM_CNT0_INTR_SET
#define Timer_Change_Color_cy_m0s8_tcpwm_1__PERIOD CYREG_TCPWM_CNT0_PERIOD
#define Timer_Change_Color_cy_m0s8_tcpwm_1__PERIOD_BUFF CYREG_TCPWM_CNT0_PERIOD_BUFF
#define Timer_Change_Color_cy_m0s8_tcpwm_1__STATUS CYREG_TCPWM_CNT0_STATUS
#define Timer_Change_Color_cy_m0s8_tcpwm_1__TCPWM_CMD CYREG_TCPWM_CMD
#define Timer_Change_Color_cy_m0s8_tcpwm_1__TCPWM_CMDCAPTURE_MASK 0x01u
#define Timer_Change_Color_cy_m0s8_tcpwm_1__TCPWM_CMDCAPTURE_SHIFT 0u
#define Timer_Change_Color_cy_m0s8_tcpwm_1__TCPWM_CMDRELOAD_MASK 0x100u
#define Timer_Change_Color_cy_m0s8_tcpwm_1__TCPWM_CMDRELOAD_SHIFT 8u
#define Timer_Change_Color_cy_m0s8_tcpwm_1__TCPWM_CMDSTART_MASK 0x1000000u
#define Timer_Change_Color_cy_m0s8_tcpwm_1__TCPWM_CMDSTART_SHIFT 24u
#define Timer_Change_Color_cy_m0s8_tcpwm_1__TCPWM_CMDSTOP_MASK 0x10000u
#define Timer_Change_Color_cy_m0s8_tcpwm_1__TCPWM_CMDSTOP_SHIFT 16u
#define Timer_Change_Color_cy_m0s8_tcpwm_1__TCPWM_CTRL CYREG_TCPWM_CTRL
#define Timer_Change_Color_cy_m0s8_tcpwm_1__TCPWM_CTRL_MASK 0x01u
#define Timer_Change_Color_cy_m0s8_tcpwm_1__TCPWM_CTRL_SHIFT 0u
#define Timer_Change_Color_cy_m0s8_tcpwm_1__TCPWM_INTR_CAUSE CYREG_TCPWM_INTR_CAUSE
#define Timer_Change_Color_cy_m0s8_tcpwm_1__TCPWM_INTR_CAUSE_MASK 0x01u
#define Timer_Change_Color_cy_m0s8_tcpwm_1__TCPWM_INTR_CAUSE_SHIFT 0u
#define Timer_Change_Color_cy_m0s8_tcpwm_1__TCPWM_NUMBER 0u
#define Timer_Change_Color_cy_m0s8_tcpwm_1__TR_CTRL0 CYREG_TCPWM_CNT0_TR_CTRL0
#define Timer_Change_Color_cy_m0s8_tcpwm_1__TR_CTRL1 CYREG_TCPWM_CNT0_TR_CTRL1
#define Timer_Change_Color_cy_m0s8_tcpwm_1__TR_CTRL2 CYREG_TCPWM_CNT0_TR_CTRL2
...
#define isr_Timer_Change_Color__INTC_MASK 0x20000u
#define isr_Timer_Change_Color__INTC_NUMBER 17u
#define isr_Timer_Change_Color__INTC_PRIOR_MASK 0xC000u
...
#define Clock_Timer_Change_Color__CTRL_REGISTER CYREG_PERI_PCLK_CTL7
#define Clock_Timer_Change_Color__DIV_ID 0x00000044u
#define Clock_Timer_Change_Color__DIV_REGISTER CYREG_PERI_DIV_16_CTL4
