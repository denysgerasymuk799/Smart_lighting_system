...
/* Timer_1 */
#define Timer_1_Clock__CTRL_REGISTER CYREG_PERI_PCLK_CTL7
#define Timer_1_Clock__DIV_ID 0x00000042u
#define Timer_1_Clock__DIV_REGISTER CYREG_PERI_DIV_16_CTL2
#define Timer_1_Clock__PA_DIV_ID 0x000000FFu
...
#define Timer_1_isr__INTC_MASK 0x20000u
#define Timer_1_isr__INTC_NUMBER 17u
#define Timer_1_isr__INTC_PRIOR_MASK 0xC000u
#define Timer_1_isr__INTC_PRIOR_NUM 3u
#define Timer_1_isr__INTC_PRIOR_REG CYREG_CM0_IPR4
...
/* PWM_1sWindow */
#define PWM_1sWindow_cy_m0s8_tcpwm_1__CC CYREG_TCPWM_CNT1_CC
#define PWM_1sWindow_cy_m0s8_tcpwm_1__CC_BUFF CYREG_TCPWM_CNT1_CC_BUFF
#define PWM_1sWindow_cy_m0s8_tcpwm_1__COUNTER CYREG_TCPWM_CNT1_COUNTER
#define PWM_1sWindow_cy_m0s8_tcpwm_1__CTRL CYREG_TCPWM_CNT1_CTRL
#define PWM_1sWindow_cy_m0s8_tcpwm_1__INTR CYREG_TCPWM_CNT1_INTR
#define PWM_1sWindow_cy_m0s8_tcpwm_1__INTR_MASK CYREG_TCPWM_CNT1_INTR_MASK
#define PWM_1sWindow_cy_m0s8_tcpwm_1__INTR_MASKED CYREG_TCPWM_CNT1_INTR_MASKED
#define PWM_1sWindow_cy_m0s8_tcpwm_1__INTR_SET CYREG_TCPWM_CNT1_INTR_SET
#define PWM_1sWindow_cy_m0s8_tcpwm_1__PERIOD CYREG_TCPWM_CNT1_PERIOD
#define PWM_1sWindow_cy_m0s8_tcpwm_1__PERIOD_BUFF CYREG_TCPWM_CNT1_PERIOD_BUFF
#define PWM_1sWindow_cy_m0s8_tcpwm_1__STATUS CYREG_TCPWM_CNT1_STATUS
#define PWM_1sWindow_cy_m0s8_tcpwm_1__TCPWM_CMD CYREG_TCPWM_CMD
#define PWM_1sWindow_cy_m0s8_tcpwm_1__TCPWM_CMDCAPTURE_MASK 0x02u
#define PWM_1sWindow_cy_m0s8_tcpwm_1__TCPWM_CMDCAPTURE_SHIFT 1u
#define PWM_1sWindow_cy_m0s8_tcpwm_1__TCPWM_CMDRELOAD_MASK 0x200u
#define PWM_1sWindow_cy_m0s8_tcpwm_1__TCPWM_CMDRELOAD_SHIFT 9u
#define PWM_1sWindow_cy_m0s8_tcpwm_1__TCPWM_CMDSTART_MASK 0x2000000u
#define PWM_1sWindow_cy_m0s8_tcpwm_1__TCPWM_CMDSTART_SHIFT 25u
#define PWM_1sWindow_cy_m0s8_tcpwm_1__TCPWM_CMDSTOP_MASK 0x20000u
#define PWM_1sWindow_cy_m0s8_tcpwm_1__TCPWM_CMDSTOP_SHIFT 17u
#define PWM_1sWindow_cy_m0s8_tcpwm_1__TCPWM_CTRL CYREG_TCPWM_CTRL
#define PWM_1sWindow_cy_m0s8_tcpwm_1__TCPWM_CTRL_MASK 0x02u
#define PWM_1sWindow_cy_m0s8_tcpwm_1__TCPWM_CTRL_SHIFT 1u
#define PWM_1sWindow_cy_m0s8_tcpwm_1__TCPWM_INTR_CAUSE CYREG_TCPWM_INTR_CAUSE
#define PWM_1sWindow_cy_m0s8_tcpwm_1__TCPWM_INTR_CAUSE_MASK 0x02u
#define PWM_1sWindow_cy_m0s8_tcpwm_1__TCPWM_INTR_CAUSE_SHIFT 1u
#define PWM_1sWindow_cy_m0s8_tcpwm_1__TCPWM_NUMBER 1u
#define PWM_1sWindow_cy_m0s8_tcpwm_1__TR_CTRL0 CYREG_TCPWM_CNT1_TR_CTRL0
#define PWM_1sWindow_cy_m0s8_tcpwm_1__TR_CTRL1 CYREG_TCPWM_CNT1_TR_CTRL1
#define PWM_1sWindow_cy_m0s8_tcpwm_1__TR_CTRL2 CYREG_TCPWM_CNT1_TR_CTRL2
