...
# Date: Mon, 11 Jan 2021 22:26:35 GMT
#set_units -time ns
...
create_clock -name {Clock_Timer_Change_Color(FFB)} -period 1000000 -waveform {0 500000} [list [get_pins {ClockBlock/ff_div_7}]]
create_clock -name {Clock_Waiting_Time(FFB)} -period 1000000 -waveform {0 500000} [list [get_pins {ClockBlock/ff_div_8}]]
create_clock -name {Timer_Is_Free_Clock(FFB)} -period 1000000 -waveform {0 500000} [list [get_pins {ClockBlock/ff_div_9}]]
...
# Project: D:\ucu\2_course1_term\POC\programs\my_works\Smart_lightning_system\Mesh_Flood_Main_Auto_Reassignment2.cydsn\Mesh_Flood_Main_Auto_Reassignment2.cyprj
# Date: Mon, 11 Jan 2021 22:26:33 GMT
