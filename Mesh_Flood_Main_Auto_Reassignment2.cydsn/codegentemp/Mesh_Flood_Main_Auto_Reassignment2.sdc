...
# Date: Fri, 08 Jan 2021 18:44:16 GMT
#set_units -time ns
...
create_clock -name {Timer_1_Clock(FFB)} -period 1000000 -waveform {0 500000} [list [get_pins {ClockBlock/ff_div_7}]]
...
create_generated_clock -name {Timer_1_Clock} -source [get_pins {ClockBlock/hfclk}] -edges {1 24001 48001} [list]
